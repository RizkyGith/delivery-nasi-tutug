...
class AssetAuthMiddleware extends \Xinix\BonoAuth\Middleware\AuthMiddleware
{
        ...
        $app->post('/login', function () use ($app, $driver) {
            ...
            try {
                ...
                if (f('auth.login.success', $loginUser)) {
                	//fixme request using json not display view , only json structures
